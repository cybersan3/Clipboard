...
internal sealed class ImplementationProvider : IImplementationProvider
{
	...
	public IEnumerable<Type> GetConcreteImplementationsOf<T>() => GetConcreteImplementationsOf(typeof(T));

	public IEnumerable<Type> GetConcreteImplementationsOf(Type type)
	{
	...
	public Type GetSingleConcreteImplemenationOf(Type interfaceType)
	{
		var implementationTypes = GetConcreteImplementationsOf(interfaceType).ToList();
